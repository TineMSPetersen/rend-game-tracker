...
import { AddCharacter, AddCharacterSkill, AddConsumable, CharacterList, FilteredCharacterList, GetCharacterInfo, getCharacterSkills } from "../controllers/characterController.ts";
...
characterRouter.post('/usercharacters', FilteredCharacterList);
