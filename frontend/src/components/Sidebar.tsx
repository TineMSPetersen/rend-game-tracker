  ...
  return (
    <div className='w-[18%] min-h-screen border-r-2 border-gray-300'>
      <div className='flex flex-col gap-4 pt-6 pl-[20%] text-[15px]'>
        ...
        <NavLink to="/my-characters" className="flex items-center gap-3 border border-gray-300 border-r-0 px-3 py-2 rounded-xs">
          <p className='hidden md:block'>My Characters</p>
        </NavLink>
        <NavLink to="/characters" className="flex items-center gap-3 border border-gray-300 border-r-0 px-3 py-2 rounded-xs">
          <p className='hidden md:block'>All Characters</p>
        </NavLink>
